...
const Footer = () => {
  ...
  <img
    src="/images/logo/kapato logo secondary.png"
    alt="KAPATO Logo"
          ...
          <div className="md:col-span-3">
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-secondary/10 border border-secondary-30 rounded-full py-3.5 px-6 text-sm focus:outline-none focus:border-secondary/50 placeholder:text-secondary/50"
              />
