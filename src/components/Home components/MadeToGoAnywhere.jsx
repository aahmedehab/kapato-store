...
const MadeToGoAnywhere = () => {
  return (
    <div className=" mx-auto">
      ...
      <div className="relative h-[560px] lg:h-[460px] grid grid-cols-1 lg:grid-cols-5 overflow-hidden">
        ...
        <div className="absolute inset-0 lg:relative lg:col-span-2">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/50 to-primary-80 lg:hidden" />
        </div>

        {/* Blue Content - Overlay on Mobile */}
        <div className="relative z-10 lg:col-span-3 bg-primary-30 lg:bg-primary text-secondary p-10 md:p-14 lg:p-16 flex flex-col justify-center">
          ...
          <div>
            ...
            <p className="mt-5 text-base md:text-lg text-secondary max-w-md">
    ...
    />
      ...
      {/* Features Section */}
      <div className="grid grid-cols-1 md:grid-cols-3 bg-secondary divide-y md:divide-y-0 md:divide-x divide-primary-30 text-sm">
        <div className="p-8 text-center md:text-left">
          ...
          <h3 className="font-semibold text-primary">Designed For Sunny Days</h3>
        ...
        <div className="p-8 text-center md:text-left">
          ...
          <h3 className="font-semibold text-primary">Built For Every Wave</h3>
          <p className="mt-2 text-gray-600 text-sm">
        ...
        <div className="p-8 text-center md:text-left">
          ...
          <h3 className="font-semibold text-primary">Inspired By The Coast</h3>
          <p className="mt-2 text-gray-600 text-sm">
